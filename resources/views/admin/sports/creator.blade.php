                ...
                <div class="card-box">
                    <div class="col-12">
                        <div class="header-title mb-4">
                            <div><h4 class="text-orange">Create Sports</h4></div>
                        </div>
                    </div>
                     ...
                     <form action="{{ route('storeSport') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="name" placeholder="Enter Sport Name" class="form-control" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="logo" id="input-file-now" accept="image/*" data-default-file="{{ asset('files/sport/no-img.png') }}" class="dropify" data-height="300"/>
                            @if ($errors->has('logo'))<p style="color:red;">{{ $errors->first('logo') }}</p>@endif
                        </div>
                        <input type="submit" name="submit" value="Add Sport" class="btn btn-primary btn-rounded">
                    </form>
